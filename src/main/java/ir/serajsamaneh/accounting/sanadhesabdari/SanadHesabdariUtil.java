...
public class SanadHesabdariUtil {
	...
	public static SanadHesabdariEntity createMergedSanadHesabdari(Long organId, Date sanadHesabdariDate,
			List<SanadHesabdariItemEntity> articles, String description, SanadTypeEntity sanadType,
			boolean concatDescriptions, SanadStateEnum sanadStateEnum, SaalMaaliEntity saalMaali, YesNoEnum deletable,
			int numberOfDecimals, UserEntity currentUser, String organDesc) {
		return createMergedSanadHesabdari(organId, sanadHesabdariDate, articles, description, sanadType,
				concatDescriptions, sanadStateEnum, true, saalMaali, deletable, numberOfDecimals, currentUser,
				organDesc);
	}

	public static SanadHesabdariEntity createMergedEkhtetamiehSanadHesabdari(Long organId, Date sanadHesabdariDate,
			List<SanadHesabdariItemEntity> articles, String description, SanadTypeEntity sanadType,
			boolean concatDescriptions, SanadStateEnum sanadStateEnum, boolean validateSaalMaaliInProgress,
			SaalMaaliEntity currentUserActiveSaalMaali, YesNoEnum deletable, int numberOfDecimals,
...
//		SaalMaaliEntity saalMaaliEntity = saalMaaliService.getSaalmaaliByDate(sanadHesabdariDate, organEntity);
		for (SanadHesabdariItemEntity sanadHesabdariItemEntity : mergedArticles) {
			sanadHesabdariItemEntity.setDescription(SerajMessageUtil.getMessage("SanadHesabdari_createSanadEkhtetamieh",
					currentUserActiveSaalMaali.getDesc()));
		}
		return createSanadHesabdari(organId, sanadHesabdariDate, mergedArticles, description, sanadType, sanadStateEnum,
				validateSaalMaaliInProgress, null, currentUserActiveSaalMaali, deletable, numberOfDecimals, currentUser,
				organDesc);
	}
	...
	public static SanadHesabdariEntity createMergedSanadHesabdari(Long organId, Date sanadHesabdariDate,
			List<SanadHesabdariItemEntity> articles, String description, SanadTypeEntity sanadType,
			boolean concatDescriptions, SanadStateEnum sanadStateEnum, boolean validateSaalMaaliInProgress,
			SaalMaaliEntity saalMaali, YesNoEnum deletable, int numberOfDecimals, UserEntity currentUser,
			String organDesc) {

		List<SanadHesabdariItemEntity> mergedArticles = createMergedArticles(articles, concatDescriptions, organId);

		return createSanadHesabdari(organId, sanadHesabdariDate, mergedArticles, description, sanadType, sanadStateEnum,
				validateSaalMaaliInProgress, null, saalMaali, deletable, numberOfDecimals, currentUser, organDesc);
	}

	public static List<SanadHesabdariItemEntity> createMergedArticles(List<SanadHesabdariItemEntity> articles,
			boolean concatDescriptions, Long organId) {
	...
	public static List<SanadHesabdariItemEntity> createMergedArticlesKeepingBedehkarBestankar(
			List<SanadHesabdariItemEntity> articles, boolean concatDescriptions, Long organId) {

		Map<String, SanadHesabdariItemEntity> articlesMap = mergeArtcilesKeepingBedehkarBestankarToArticleMap(articles,
				concatDescriptions, organId);
	...
	public static SanadHesabdariEntity createSanadHesabdari(Long organId, Date sanadHesabdariDate,
			List<SanadHesabdariItemEntity> articles, String description, SanadTypeEntity sanadType,
			SanadStateEnum sanadStateEnum, SaalMaaliEntity saalMaaliEntity, YesNoEnum deletable, int numberOfDecimals,
			UserEntity currentUser, String organDesc) {
		return createSanadHesabdari(organId, sanadHesabdariDate, articles, description, sanadType, sanadStateEnum, true,
	...
	public static SanadHesabdariEntity createSanadHesabdari(Long organId, Date sanadHesabdariDate,
			List<SanadHesabdariItemEntity> articles, String description, SanadTypeEntity sanadType,
			SanadStateEnum sanadStateEnum, boolean validateSaalMaaliInProgress, String sanadRole,
			SaalMaaliEntity saalMaaliEntity, YesNoEnum deletable, int numberOfDecimals, UserEntity currentUser,
			String organDesc) {
	...
	protected static Map<String, SanadHesabdariItemEntity> mergeArtcilesToArticleMap(
			List<SanadHesabdariItemEntity> articles, boolean concatDescriptions, Long organId) {
	...
	protected static Map<String, SanadHesabdariItemEntity> mergeArtcilesKeepingBedehkarBestankarToArticleMap(
			List<SanadHesabdariItemEntity> articles, boolean concatDescriptions, Long organId) {
	...
	private static void mergeArtcilesToArticleMap(boolean concatDescriptions,
			Map<String, SanadHesabdariItemEntity> articlesMap, SanadHesabdariItemEntity sanadHesabdariItemEntity,
			String mapKey) {
		...
		if (previousSanad == null) {
			...
			if (StringUtils.hasText(sanadHesabdariItemEntity.getDescription()) && concatDescriptions)
				previousSanad.setDescription(
						previousSanad.getDescription() + "," + sanadHesabdariItemEntity.getDescription());
...
//	}
	...
	public static String createMapKey(SanadHesabdariItemEntity sanadHesabdariItemEntity, Long organId) {
		String mapKey = "";
		...
		String tafsiliCode = sanadHesabdariItemEntity.getHesabTafsili() != null
				? sanadHesabdariItemEntity.getHesabTafsili().getCode().toString()
				: "";
		mapKey += "_" + tafsiliCode;

		String tafsiliTwoCode = sanadHesabdariItemEntity.getHesabTafsiliTwo() != null
				? sanadHesabdariItemEntity.getHesabTafsiliTwo().getCode().toString()
				: "";
...
//		}
		...
		String markazCode = sanadHesabdariItemEntity.getAccountingMarkaz() != null
				? sanadHesabdariItemEntity.getAccountingMarkaz().getCode()
				: "";
		mapKey += "_" + markazCode;
...
//		}
	...
	public static List<SanadHesabdariItemEntity> getSortedSanadHesabdariItem(
			List<SanadHesabdariItemEntity> sanadHesabdariItemList) {
	...
	public static List<SanadHesabdariItemEntity> getSortedBedehkarSanadHesabdariItem(
			List<SanadHesabdariItemEntity> sanadHesabdariItemList) {
		List<SanadHesabdariItemEntity> result = new ArrayList<SanadHesabdariItemEntity>();
		for (SanadHesabdariItemEntity sanadHesabdariItemEntity : sanadHesabdariItemList) {
			...
			for (; index < result.size(); index++) {
				if (Long.valueOf(sanadHesabdariItemEntity.getHesabKol().getCode()) < Long
						.valueOf(result.get(index).getHesabKol().getCode()))
					break;
			}
	...
	public static List<SanadHesabdariItemEntity> getSortedBestankarSanadHesabdariItem(
			List<SanadHesabdariItemEntity> sanadHesabdariItemList) {
		List<SanadHesabdariItemEntity> result = new ArrayList<SanadHesabdariItemEntity>();
		for (SanadHesabdariItemEntity sanadHesabdariItemEntity : sanadHesabdariItemList) {
	...
	public static void checkSanadHesabdariUniqueness(Date sanadHesabDariDate, Long sanadTypeId, Long organId) {
		...
		SanadHesabdariEntity sanadHesabdariEntity = getLocalSanadHesabdariByDateAndType(sanadHesabDariDate, sanadTypeId,
				organId);
		if (sanadHesabdariEntity != null) {
			SanadTypeEntity sanadTypeEntity = sanadTypeService.load(sanadTypeId);
			throw new DuplicateException(
					SerajMessageUtil.getMessage("sanadAutomaticAlreadyCreated", sanadTypeEntity.getName(),
							DateConverter.toShamsiDate(sanadHesabDariDate), sanadHesabdariEntity.getTempSerial()));
		}
	}

	public static SanadHesabdariEntity getLocalSanadHesabdariByDateAndType(Date sanadHesabDariDate, Long sanadTypeId,
			Long organId) {
	...
	public static HesabKolEntity getHesabKolByTemplateId(Long hesabKolTemplateId, Long saalMaaliId) {
		HesabKolTemplateEntity hesabKolTemplateEntity = hesabKolTemplateService.load(hesabKolTemplateId);
		return getHesabKolByTemplate(hesabKolTemplateEntity, saalMaaliId);
	}

	public static HesabKolEntity getHesabKolByTemplate(HesabKolTemplateEntity hesabKolTemplateEntity,
			Long saalMaaliId) {
	...
	public static HesabMoeenEntity getHesabMoeenByTemplate(HesabMoeenTemplateEntity hesabMoeenTemplateEntity,
			Long saalMaaliId) {
		return hesabMoeenService.loadHesabMoeenByCode(hesabMoeenTemplateEntity.getCode(), saalMaaliId);
	}
	...
	public static HesabTafsiliEntity getHesabTafsiliByTemplate(HesabTafsiliTemplateEntity hesabTafsiliTemplateEntity,
			Long saalMaaliId) {
		if (hesabTafsiliTemplateEntity == null)
			return null;
		return hesabTafsiliService.loadHesabTafsiliByCode(Long.valueOf(hesabTafsiliTemplateEntity.getCode()),
				saalMaaliId);
	}
	...
	public static AccountingMarkazEntity getAccountingMarkazByTemplate(
			AccountingMarkazTemplateEntity accountingMarkazTemplateEntity, Long saalMaaliId) {
		if (accountingMarkazTemplateEntity == null)
			return null;
		return accountingMarkazService.loadAccountingMarkazByCode(accountingMarkazTemplateEntity.getCode(),
				saalMaaliId);
	}
...
//		String reportFileName = "PrintSanad2";
	...
	public static byte[] printSanad(SanadHesabdariEntity sanadHesabdariEntity, String reportFileName)
			throws JRException {
...
//		try {
		...
		parameters.put("tanzimKonandeh",
				sanadHesabdariEntity.getTanzimKonnadeSanad() != null
						? sanadHesabdariEntity.getTanzimKonnadeSanad().getShakhsName()
						: "");
		parameters.put("tayidKonandeh",
				sanadHesabdariEntity.getTaiedKonnadeSanad() != null
						? sanadHesabdariEntity.getTaiedKonnadeSanad().getShakhsName()
						: "");
		...
		List<SanadHesabdariItemEntity> sanadItemList = sanadHesabdariEntity.getSanadHesabdariItem();
		JRBeanCollectionDataSource ds = new JRBeanCollectionDataSource(sanadItemList);

//			String filePath = "/WEB-INF/classes/report/PrintSanad.jrxml";

		String reportPath = SanadHesabdariUtil.class.getClassLoader()
				.getResource("/report/" + reportFileName + ".jrxml").getFile();
