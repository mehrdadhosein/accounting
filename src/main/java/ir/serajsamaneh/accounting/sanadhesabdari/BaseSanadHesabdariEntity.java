 ...
 *
 * @hibernate.class table="tb_sanad_hesabdari"
 */
...
//	private ir.serajsamaneh.core.organ.OrganEntity organ;
	 ...
	 * 
	 * @hibernate.id generator-class="increment" column="sanad_hesabdari_id"
	 */
...
//	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ir.serajsamaneh.accounting.sanadhesabdari.SanadHesabdariEntity))
			return false;
		else {
			...
			if (null == this.getId() || null == sanadHesabdariEntity.getId())
				return false;
			else
				return (this.getId().equals(sanadHesabdariEntity.getId()));
		}
	}
