...
public class HesabTafsiliTemplateService extends BaseEntityService<HesabTafsiliTemplateEntity, Long> {
	...
	public void save(HesabTafsiliTemplateEntity entity, List<Long> moeenIds, List<Long> childTafsiliIds, Long organId) {
		...
		for (Long moeenId : moeenIds) {
			...
			moeenTafsiliTemplateEntity.setHesabMoeenTemplate(hesabMoeenTemplateService.load(moeenId));
	...
	@Transactional
	public HesabTafsiliTemplateEntity createHesabTafsiliTemplate(Long hesabTafsiliCode, String hesabTafsiliName,
			Long organId, TafsilTypeEnum tafsilType, String description, Integer level, String organName) {
	...
	public List<HesabTafsiliTemplateEntity> getRootHesabs(List<Long> topOrganList) {
		...
		for (HesabTafsiliTemplateEntity hesabTafsiliEntity : activeTafsilis) {
			if (hesabTafsiliEntity.getChilds() == null || hesabTafsiliEntity.getChilds().isEmpty())
				if (hesabTafsiliEntity.getMoeenTafsiliTemplate() != null
						&& !hesabTafsiliEntity.getMoeenTafsiliTemplate().isEmpty())
