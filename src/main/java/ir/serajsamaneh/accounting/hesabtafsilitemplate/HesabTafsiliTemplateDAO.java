...
public class HesabTafsiliTemplateDAO extends BaseHibernateDAO<HesabTafsiliTemplateEntity, Long> {
	...
	@Transactional
	public void save(Long hesabTafsiliCode, String hesabTafsiliName, String hesabMoeenCode, Long organId, Integer level,
			String organName) {
		...
		HesabMoeenTemplateEntity moeenTemplateEntity = hesabMoeenTemplateDAO.getHesabMoeenTemplateByCode(hesabMoeenCode,
				organId);
		...
		if (moeenTemplateEntity != null && moeenTemplateEntity.getId() != null) {
			...
			moeenTafsiliTemplateEntity.setHesabMoeenTemplate(hesabMoeenTemplateDAO.load(moeenTemplateEntity.getId()));
		...
		if (hesabTafsiliTemplateEntity.getMoeenTafsiliTemplate() != null)
			for (MoeenTafsiliTemplateEntity moeenTafsiliEntity : hesabTafsiliTemplateEntity.getMoeenTafsiliTemplate()) {
				MoeenTafsiliTemplateEntity moeenTafsiliTemplateEntity = new MoeenTafsiliTemplateEntity();
				moeenTafsiliTemplateEntity.setHesabMoeenTemplate(
						hesabMoeenTemplateDAO.load(moeenTafsiliEntity.getHesabMoeenTemplate().getId()));
				moeenTafsiliTemplateEntity.setHesabTafsiliTemplate(hesabTafsiliTemplateEntity);
		...
		checkUniqueNess(hesabTafsiliTemplateEntity, HesabTafsiliTemplateEntity.PROP_CODE,
				hesabTafsiliTemplateEntity.getCode(), localFilter, false);
