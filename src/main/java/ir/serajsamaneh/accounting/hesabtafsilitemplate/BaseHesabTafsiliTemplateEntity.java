...
/**
 * This is an object that contains data related to the tb_hesab_tafsili_template
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="tb_hesab_tafsili_template"
 */
...
//	OrganEntity organ;
	 ...
	 * 
	 * @hibernate.id generator-class="increment" column="hesab_tafsili_template_id"
	 */
...
//	}
	...
	public void setParent(
			java.util.Set<ir.serajsamaneh.accounting.hesabtafsilitemplate.HesabTafsiliTemplateEntity> parent) {
		this.parent = parent;
	}

	public void addToparent(
			ir.serajsamaneh.accounting.hesabtafsilitemplate.HesabTafsiliTemplateEntity hesabTafsiliTemplateEntity) {
		if (null == getParent())
			setParent(
					new java.util.TreeSet<ir.serajsamaneh.accounting.hesabtafsilitemplate.HesabTafsiliTemplateEntity>());
	...
	public void setChilds(
			java.util.Set<ir.serajsamaneh.accounting.hesabtafsilitemplate.HesabTafsiliTemplateEntity> childs) {
		this.childs = childs;
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ir.serajsamaneh.accounting.hesabtafsilitemplate.HesabTafsiliTemplateEntity))
			return false;
		else {
			...
			if (null == this.getId() || null == hesabTafsiliTemplateEntity.getId())
				return false;
			else
				return (this.getId().equals(hesabTafsiliTemplateEntity.getId()));
		}
	}
