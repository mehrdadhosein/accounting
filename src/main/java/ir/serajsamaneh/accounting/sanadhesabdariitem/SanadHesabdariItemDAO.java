...
public class SanadHesabdariItemDAO extends BaseHibernateDAO<SanadHesabdariItemEntity, Long> {
	...
	public List<Object[]> getTarazKolAzmayeshi(Map<String, Object> filter) {
		...
		String kolIdProp = newCreateAlias(criteria, aliasMap, "hesabKol.id",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
		String kolCodeProp = newCreateAlias(criteria, aliasMap, "hesabKol.code",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
	...
	public List<Object[]> getTarazMoeenAzmayeshi(Map<String, Object> filter) {
		...
		String moeenId = newCreateAlias(criteria, aliasMap, "hesabMoeen.id",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
		String moeenCode = newCreateAlias(criteria, aliasMap, "hesabMoeen.code",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
	...
	public List<Object[]> getTarazTafsiliAzmayeshi(Map<String, Object> filter) {
		...
		String tafsiliId = newCreateAlias(criteria, aliasMap, "hesabTafsili.id",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
		String tafsiliCode = newCreateAlias(criteria, aliasMap, "hesabTafsili.code",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
	...
	public List<Object[]> getTarazTafsiliAzmayeshiTwo(Map<String, Object> filter) {
		...
		String tafsiliId = newCreateAlias(criteria, aliasMap, "hesabTafsiliTwo.id",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
		String tafsiliCode = newCreateAlias(criteria, aliasMap, "hesabTafsiliTwo.code",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
	...
	public List<Object[]> getTarazShenavarAzmayeshi(Map<String, Object> filter) {
		...
		String tafsiliId = newCreateAlias(criteria, aliasMap, "articleTafsili.hesabTafsili.id",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
		String tafsiliCode = newCreateAlias(criteria, aliasMap, "articleTafsili.hesabTafsili.code",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
	...
	public List<Object[]> getTarazAccountingMarkazAzmayeshi(Map<String, Object> filter) {
		...
		String accountingMarkazId = newCreateAlias(criteria, aliasMap, "accountingMarkaz.id",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
		String accountingMarkazCode = newCreateAlias(criteria, aliasMap, "accountingMarkaz.code",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
	...
	public List<Object[]> getTarazAccountingMarkazShenavarAzmayeshi(Map<String, Object> filter) {
		...
		String accountingMarkazId = newCreateAlias(criteria, aliasMap, "articleAccountingMarkaz.accountingMarkaz.id",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
		String accountingMarkazCode = newCreateAlias(criteria, aliasMap,
				"articleAccountingMarkaz.accountingMarkaz.code",
				JoinType.INNER_JOIN /* CriteriaSpecification.INNER_JOIN */);
	...
	@Transactional(readOnly = true)
	public Double[] getHesabAggregate(Long kolId, HesabTypeEnum hesabTypeEnum, Date from, Date to,
