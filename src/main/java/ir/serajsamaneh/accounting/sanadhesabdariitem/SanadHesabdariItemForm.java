...
//		OrganEntity selectedOrgan = getSelectedOrganId()!=null ? getOrganService().load(getSelectedOrganId()) : null;
	...
	private List<SanadHesabdariItemVO> extractTarazKolAzmayeshi(Long organId) {
		populateFilterFromRequest();
		List<SanadHesabdariItemVO> tarazKolAzmayeshi = getMyService().getTarazKolAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),null,organId, getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getDisplayZeroMandehInTaraz(), getBeforeClosingAccounts(), getNumberOfDecimals());
...
//		OrganEntity selectedOrgan = getSelectedOrganId()!=null ? getOrganService().load(getSelectedOrganId()) : null;
	...
	private List<SanadHesabdariItemVO> extractTarazMoeenAzmayeshi(Long organId) {
		populateFilterFromRequest();
		List<SanadHesabdariItemVO> tarazMoeenAzmayeshi = getMyService().getTarazMoeenAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),null,organId, getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getDisplayZeroMandehInTaraz(), getNumberOfDecimals());
	...
	public List<SanadHesabdariItemVO> getTarazTafsiliAzmayeshiTwo() {
		...
		if(!FacesContext.getCurrentInstance().getRenderResponse())
			return new ArrayList<SanadHesabdariItemVO>();
		setSearchAction(true);
		List<SanadHesabdariItemVO> tarazTafsiliAzmayeshiTwo = extractTarazTafsiliAzmayeshiTwo(getCurrentOrganVO().getId());
...
//		System.out.println(FacesContext.getCurrentInstance().getRenderResponse());
		if(!FacesContext.getCurrentInstance().getRenderResponse())
			return new ArrayList<SanadHesabdariItemVO>();
		setSearchAction(true);
		List<SanadHesabdariItemVO> tarazAccountingMarkazAzmayeshi = extractTarazAccountingMarkazAzmayeshi(getCurrentOrganVO().getId());
...
//		System.out.println(FacesContext.getCurrentInstance().getRenderResponse());
		...
		setSearchAction(true);
		List<SanadHesabdariItemEntity> tarazAccountingMarkazAzmayeshi = extractTarazAccountingMarkazShenavarAzmayeshi(getCurrentOrganVO().getId());
		return tarazAccountingMarkazAzmayeshi;
	}
	...
	public List<SanadHesabdariItemVO> getHierarchicalTarazAccountingMarkazAzmayeshi() {
		...
		setSearchAction(true);
//		OrganEntity selectedOrgan = getSelectedOrganId()!=null ? getOrganService().load(getSelectedOrganId()) : null;
		List<SanadHesabdariItemVO> tarazAccountingMarkazAzmayeshi = extractTarazAccountingMarkazAzmayeshi(getSelectedOrganId());
		return tarazAccountingMarkazAzmayeshi; 
	}

	private List<SanadHesabdariItemVO> extractTarazTafsiliAzmayeshi(Long organId) {
		populateFilterFromRequest();
		List<SanadHesabdariItemVO> tarazTafsiliAzmayeshi = getMyService().getTarazTafsiliAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),null,organId, getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getDisplayZeroMandehInTaraz(), getNumberOfDecimals());
	...
	private List<SanadHesabdariItemVO> extractTarazTafsiliAzmayeshiTwo(Long organId) {
		populateFilterFromRequest();
		List<SanadHesabdariItemVO> tarazTafsiliAzmayeshiTwo = getMyService().getTarazTafsiliAzmayeshiTwo(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),null,organId, getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getDisplayZeroMandehInTaraz(), getNumberOfDecimals());
...
//	}
	...
	private List<SanadHesabdariItemVO> extractTarazAccountingMarkazAzmayeshi(Long organId) {
		populateFilterFromRequest();
		List<SanadHesabdariItemVO> tarazAccountingMarkazAzmayeshi = getMyService().getTarazAccountingMarkazAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),null,organId, getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getDisplayZeroMandehInTaraz(), getBeforeClosingAccounts(), getNumberOfDecimals());
	...
	private List<SanadHesabdariItemEntity> extractTarazAccountingMarkazShenavarAzmayeshi(Long organId) {
		populateFilterFromRequest();
		List<SanadHesabdariItemEntity> tarazAccountingMarkazAzmayeshi = getMyService().getTarazAccountingMarkazShenavarAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),null,organId, getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getDisplayZeroMandehInTaraz(), getBeforeClosingAccounts(), getNumberOfDecimals());
	...
	public List<SanadHesabdariItemVO> getTarazKolDarayi() {
		return getMyService().getTarazKolAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.ASSET,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getTarazKolBedehi() {
		return getMyService().getTarazKolAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.LIABILITY,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getTarazKolSarmaye() {
		return getMyService().getTarazKolAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.EQUITY,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getTarazMoeenDarayi() {
		return getMyService().getTarazMoeenAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.ASSET,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getBeforeClosingAccounts(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getTarazMoeenBedehi() {
		return getMyService().getTarazMoeenAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.LIABILITY,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getBeforeClosingAccounts(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getTarazMoeenSarmaye() {
		return getMyService().getTarazMoeenAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.EQUITY,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getBeforeClosingAccounts(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getTarazTafsiliDarayi() {
		return getMyService().getTarazTafsiliAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.ASSET,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getBeforeClosingAccounts(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getTarazTafsiliBedehi() {
		return getMyService().getTarazTafsiliAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.LIABILITY,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getBeforeClosingAccounts(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getTarazTafsiliSarmaye() {
		return getMyService().getTarazTafsiliAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.EQUITY,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getBeforeClosingAccounts(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getIncomeGroupByHesabKol( ){
		return getMyService().getTarazKolAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.INCOME,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getIncomeGroupByHesabMoeen( ){
		return getMyService().getTarazMoeenAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.INCOME,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getBeforeClosingAccounts(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getIncomeGroupByHesabTafsili( ){
		return getMyService().getTarazTafsiliAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.INCOME,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getBeforeClosingAccounts(), getNumberOfDecimals());
	}
	
	public List<SanadHesabdariItemVO> getExpenseGroupByHesabKol(){
		return getMyService().getTarazKolAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.EXPENSE,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getNumberOfDecimals());
	}

	public List<SanadHesabdariItemVO> getExpenseGroupByHesabMoeen(){
		return getMyService().getTarazMoeenAzmayeshi(getSelectedSaalMaali(), getFromDate(), getToDate(), getHesabKolIds(),getMoeenIds(), getTafsiliIds(), getTafsiliTwoIds(), getAccountingMarkazIds(),HesabTypeEnum.EXPENSE,getCurrentOrganVO().getId(), getFromSerial(), getToSerial(), getSanadhesabdariItemFilter(), getBeforeClosingAccounts(), getNumberOfDecimals());
	}
...
//		OrganEntity selectedOrgan = getSelectedOrganId()!=null ? getOrganService().load(getSelectedOrganId()) : null;
	...
	private String printTarazAccountingMarkazShenavarAzmayeshi(String organName, Long organId) {
		List<SanadHesabdariItemEntity> tarazAccountingMarkazAzmayehiList = extractTarazAccountingMarkazShenavarAzmayeshi(organId);
		Map<String, Object> parameters = populateReportParameters(organName);
...
//		}
	...
	public String printTarazKol() {
		...
		try {
			...
			byte[] pdf = JasperExportManager.exportReportToPdf(jasperPrint);
			String contentType = "application/pdf";
			downloadStream(pdf, contentType, SerajMessageUtil.getMessage("tarazKol")+"_"+ getCurrentOrganVO().getName()+".pdf");
		} catch (JRException e) {
			e.printStackTrace();
		}
	...
	public String printTarazMoeen() {
		...
		try {
			...
			byte[] pdf = JasperExportManager.exportReportToPdf(jasperPrint);
			String contentType = "application/pdf";
			downloadStream(pdf, contentType, SerajMessageUtil.getMessage("tarazMoeen")+"_"+ getCurrentOrganVO().getName()+".pdf");
		} catch (JRException e) {
			e.printStackTrace();
		}
	...
	public String printTarazTafsili() {
		...
		try {
			...
			byte[] pdf = JasperExportManager.exportReportToPdf(jasperPrint);
			String contentType = "application/pdf";
			downloadStream(pdf, contentType, SerajMessageUtil.getMessage("tarazTafsili")+"_"+ getCurrentOrganVO().getName()+".pdf");
		} catch (JRException e) {
			e.printStackTrace();
		}
	...
	public void populateDaftarKolJsonList(){
		...
		try {
			...
			for (SanadHesabdariItemEntity sanadHesabdariItemEntity : list) {
				...
				String[] nextLine = {Integer.valueOf(++index).toString(), sanadHesabdariItemEntity.getSanadHesabdari().getId().toString(), sanadHesabdariItemEntity.getTempSanadSerial(), sanadHesabdariItemEntity.getSanadSerial(), sanadHesabdariItemEntity.getSanadHesabdari().getTarikhSanadFA(), sanadHesabdariItemEntity.getHesabKol().getName(), sanadHesabdariItemEntity.getHesabKolCode(), sanadHesabdariItemEntity.getDescription(), NumberUtil.getBigDecimalFormatted(sanadHesabdariItemEntity.getBedehkar(),getNumberOfDecimals()), NumberUtil.getBigDecimalFormatted(sanadHesabdariItemEntity.getBestankar(),getNumberOfDecimals()), NumberUtil.getBigDecimalFormatted(mandeh,getNumberOfDecimals()),tashkhis};
