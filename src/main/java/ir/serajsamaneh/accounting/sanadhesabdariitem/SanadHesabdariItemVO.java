...
//	protected java.lang.String accountingMarkazLevelNames="";
	...
	public SanadHesabdariItemVO(SanadHesabdariItemEntity sanadHesabdariItemEntity, int numberOfDecimals) {
		...
		String bedehkarFormatted = NumberUtil.getBigDecimalFormatted(sanadHesabdariItemEntity.getBedehkar(),
				numberOfDecimals);
		setBedehkarFormatted(bedehkarFormatted.equals("0") ? "" : bedehkarFormatted);

		String bestankarFormatted = NumberUtil.getBigDecimalFormatted(sanadHesabdariItemEntity.getBestankar(),
				numberOfDecimals);
...
//		}
		...
		String moeenDesc = sanadHesabdariItemEntity.getHesabMoeen() != null
				? sanadHesabdariItemEntity.getHesabMoeen().getDesc()
				: "";
		String moeenName = sanadHesabdariItemEntity.getHesabMoeen() != null
				? sanadHesabdariItemEntity.getHesabMoeen().getName()
				: "";
		setHesabMoeenName(convertNullToString(moeenName));
		setHesabMoeenDesc(convertNullToString(moeenDesc));

		setHesabMoeenID(convertNullToString(
				sanadHesabdariItemEntity.getHesabMoeen() != null ? sanadHesabdariItemEntity.getHesabMoeen().getId()
						: ""));
