...
//	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ir.serajsamaneh.accounting.sanadhesabdariitem.SanadHesabdariItemEntity))
			return false;
		else {
			...
			if (null == this.getId() || null == sanadHesabdariItemEntity.getId())
				return false;
			else
				return (this.getId().equals(sanadHesabdariItemEntity.getId()));
		}
	}
