...
/**
 * This is an object that contains data related to the tb_moeen_tafsili_template
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="tb_moeen_tafsili_template"
 */
...
public abstract class BaseMoeenTafsiliTemplateEntity extends BaseEntity<Long> implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="increment" column="moeen_tafsili_template_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ir.serajsamaneh.accounting.moeentafsilitemplate.MoeenTafsiliTemplateEntity))
			return false;
		else {
			...
			if (null == this.getId() || null == moeenTafsiliTemplateEntity.getId())
				return false;
			else
				return (this.getId().equals(moeenTafsiliTemplateEntity.getId()));
		}
	}
