...
public abstract class BaseMoeenTafsiliEntity extends BaseEntity<Long> implements Serializable {
	 ...
	 */
	public BaseMoeenTafsiliEntity(java.lang.Long id, ir.serajsamaneh.accounting.hesabmoeen.HesabMoeenEntity hesabMoeen,
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ir.serajsamaneh.accounting.moeentafsili.MoeenTafsiliEntity))
			return false;
		else {
			...
			if (null == this.getId() || null == moeenTafsiliEntity.getId())
				return false;
			else
				return (this.getId().equals(moeenTafsiliEntity.getId()));
		}
	}
