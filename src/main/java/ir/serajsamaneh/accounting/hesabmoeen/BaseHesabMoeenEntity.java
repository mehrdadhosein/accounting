...
/**
 * This is an object that contains data related to the tb_hesab_moeen table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="tb_hesab_moeen"
 */
...
//	public static String PROP_MAHYAT_MOEEN = "mahyatMoeen";
	 ...
	 */
	public BaseHesabMoeenEntity(java.lang.Long id, ir.serajsamaneh.accounting.hesabkol.HesabKolEntity hesabKol,
...
//	}
	 ...
	 * 
	 * @hibernate.id generator-class="increment" column="hesab_moeen_id"
	 */
...
//	}
	 ...
	 */
	public void setMoeenTafsili(
			java.util.Set<ir.serajsamaneh.accounting.moeentafsili.MoeenTafsiliEntity> moeenTafsili) {
	...
	public void addTomoeenTafsili(ir.serajsamaneh.accounting.moeentafsili.MoeenTafsiliEntity moeenTafsiliEntity) {
		if (null == getMoeenTafsili())
			setMoeenTafsili(new java.util.TreeSet<ir.serajsamaneh.accounting.moeentafsili.MoeenTafsiliEntity>());
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ir.serajsamaneh.accounting.hesabmoeen.HesabMoeenEntity))
			return false;
		else {
			...
			if (null == this.getId() || null == hesabMoeenEntity.getId())
				return false;
			else
				return (this.getId().equals(hesabMoeenEntity.getId()));
		}
	}
