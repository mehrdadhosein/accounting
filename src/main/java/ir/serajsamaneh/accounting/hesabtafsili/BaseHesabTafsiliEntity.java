...
//	}
	...
	public void addTochilds(ir.serajsamaneh.accounting.hesabtafsili.HesabTafsiliEntity hesabTafsiliEntity) {
		if (null == getChilds())
			setChilds(new java.util.TreeSet<ir.serajsamaneh.accounting.hesabtafsili.HesabTafsiliEntity>());
	...
	public void addToparents(ir.serajsamaneh.accounting.hesabtafsili.HesabTafsiliEntity hesabTafsiliEntity) {
		if (null == getParents())
			setParents(new java.util.TreeSet<ir.serajsamaneh.accounting.hesabtafsili.HesabTafsiliEntity>());
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ir.serajsamaneh.accounting.hesabtafsili.HesabTafsiliEntity))
			return false;
		else {
