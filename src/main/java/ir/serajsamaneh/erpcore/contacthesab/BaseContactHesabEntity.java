 ...
 *
 * @hibernate.class table="tb_contact_hesab"
 */
...
//	private ir.serajsamaneh.accounting.hesabtafsili.HesabTafsiliEntity hesabTafsili;
	 ...
	 * 
	 * @hibernate.id generator-class="increment" column="contact_hesab_id"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ir.serajsamaneh.erpcore.contacthesab.ContactHesabEntity))
			return false;
		else {
			...
			if (null == this.getId() || null == contactHesabEntity.getId())
				return false;
			else
				return (this.getId().equals(contactHesabEntity.getId()));
		}
	}
