...
BaseEntityService<AccountingMarkazEntity, Long> {
	...
	public void saveStateLess(AccountingMarkazEntity entity,SaalMaaliEntity activeSaalMaaliEntity, String topOrganCode) {
		commonSave(entity, activeSaalMaaliEntity, topOrganCode);
	...
	private void commonSave(AccountingMarkazEntity entity,
			SaalMaaliEntity activeSaalMaaliEntity, String topOrganCode) {
	...
	private void createOrUpdateRelatedAccountingMarkazTemplate(AccountingMarkazEntity entity, Long organId, String topOrganCode) {
		...
		if(moeenAccountingMarkazSet!=null)
			for (MoeenAccountingMarkazEntity moeenAccountingMarkazEntity : moeenAccountingMarkazSet) {
				...
				moeenAccountingMarkazTemplateEntity.setHesabMoeenTemplate(getHesabMoeenTemplateService().loadByCode(moeenAccountingMarkazEntity.getHesabMoeen().getCode(), topOrganCode));
	...
	public List<AccountingMarkazEntity> getActiveAccountingMarkaz(SaalMaaliEntity currentSaalMaali, List<Long> topOrganList) {
