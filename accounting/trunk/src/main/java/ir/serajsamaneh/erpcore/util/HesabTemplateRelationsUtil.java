...
public class HesabTemplateRelationsUtil {
	...
	public static Map<Long, List<ListOrderedMap<String, Object>>> getTafsiliMoeenTemplateMap(Long organId, List<Long> topOrganList) {
		Map<Long, List<ListOrderedMap<String, Object>>> tafsiliMoeenTemplateMap = organizationalTafsiliMoeenTemplateMap.get(organId);
	...
	public static Map<Long, List<ListOrderedMap<String, Object>>> getKolMoeenTemplateMap(Long organId, String topOrganCode, List<Long> topOrganList) {
		Map<Long, List<ListOrderedMap<String, Object>>> kolMoeenTemplateMap = organizationalKolMoeenTemplateMap.get(organId);
	...
	public static Map<Long, ListOrderedMap<String, Object>> getMoeenKolTemplateMap(Long organId, List<Long> topOrganList) {
	...
	public static Map<Long, List<ListOrderedMap<String, Object>>> getMoeenTafsiliTemplateMap(Long organId, List<Long> topOrganList) {
...
//		return moeenAccountingMarkazTemplateMap;
	...
	public static Map<Long, List<ListOrderedMap<String, Object>>> getTafsiliChildTemplateMap(Long organId, List<Long> topOrganList) {

		Map<Long, List<ListOrderedMap<String, Object>>> tafsiliChildTemplateMap = organizationalTafsiliChildTemplateMap.get(organId);
	...
	public static Map<Long, List<ListOrderedMap<String, Object>>> getTafsiliAccountingMarkazChildTemplateMap(OrganVO organEntity) {
		return new HashMap<Long, List<ListOrderedMap<String, Object>>>();
...
//		return tafsiliTemplateMap;
	...
	public static Map<Long, List<ListOrderedMap<String, Object>>> getAccountingMarkazChildTemplateMap(OrganVO organEntity) {
